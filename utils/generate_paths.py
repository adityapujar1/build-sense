...
def create_text_files(inputTrainingDirectory, inputValidationDirectory, outputDirectory):
    ...
    with open(outputDirectory + "build_sense_train.txt", "w+") as trainingOutputFile:
        
        for individualTrainingImagePath in tqdm(glob.glob(inputTrainingDirectory + "*.png")):
    ...
    with open(outputDirectory + "build_sense_test.txt", "w+") as validationOutputFile:
        
        for individualValidationImagePath in tqdm(glob.glob(inputValidationDirectory + "*.png")):
